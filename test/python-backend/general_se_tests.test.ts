...
describe('Python Backend - Regex (converted)', () => {
  ...
  it('regex.findall test 11', async () => {
    ...
    expect(await re.findall("\\G\\w{2}", "abcd ef", { backend: 'python' })).toStrictEqual(["ab", "cd"]);
  });
  ...
  it('regex.findall test 12', async () => {
    ...
    expect(await re.findall("(?r).", "abc", { backend: 'python' })).toStrictEqual(["c", "b", "a"]);
  });
  ...
  it('regex.findall test 31', async () => {
    ...
    expect(await re.findall("(?r).", "abcd", { backend: 'python' })).toStrictEqual(["c", "b"]);
  });
  ...
  it('regex.findall test 37', async () => {
    ...
    expect(await re.findall("(\\w+) (\\w+)", "first second third fourth fifth", { backend: 'python' })).toStrictEqual([("first", "second");
  });
  ...
  it('regex.findall test 59', async () => {
    ...
    expect(await re.findall("[\\P{Alpha}]", "a0", { backend: 'python' })).toStrictEqual(["0"]);
  });
  ...
  it('regex.findall test 62', async () => {
    ...
    expect(await re.findall("(?V1)[[a-z]--[aei]]", "abc", { backend: 'python' })).toStrictEqual(["b", "c"]);
  });

  it('regex.findall test 63', async () => {
    // Python: self.assertEqual(regex.findall(r"(?iV1)[[a-z]--[aei]]", "abc"), ["b", "c"])
    expect(await re.findall("(?iV1)[[a-z]--[aei]]", "abc", { backend: 'python' })).toStrictEqual(["b", "c"]);
  });

  it('regex.findall test 64', async () => {
    // Python: self.assertEqual(regex.findall(r"(?V1)[\w--a]", "abc"), ["b", "c"])
    expect(await re.findall("(?V1)[\\w--a]", "abc", { backend: 'python' })).toStrictEqual(["b", "c"]);
  });

  it('regex.findall test 65', async () => {
    // Python: self.assertEqual(regex.findall(r"(?iV1)[\w--a]", "abc"), ["b", "c"])
    expect(await re.findall("(?iV1)[\\w--a]", "abc", { backend: 'python' })).toStrictEqual(["b", "c"]);
  });
});
