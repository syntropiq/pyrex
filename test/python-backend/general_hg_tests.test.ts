...
describe('Python Backend - Regex (converted)', () => {
  ...
  it('regex.findall test 1', async () => {
    ...
    expect(await re.findall("\\((?:(?>[^()]+)|(?R))*\\)", "a(bcd(e)f)g(h)", { backend: 'python' })).toStrictEqual(["(bcd(e);
  });
  ...
  it('regex.findall test 3', async () => {
    ...
    expect(await re.findall("\\((?:(?>[^()]+)|(?R))*\\)", "a(b(cd)e)f)g)h", { backend: 'python' })).toStrictEqual(["(b(cd);
  });

  it('regex.findall test 4', async () => {
    // Python: self.assertEqual(regex.findall(r"\((?:(?>[^()]+)|(?R))*\)", "a(bc(d(e)f)gh"), ["(d(e)f)"])
    expect(await re.findall("\\((?:(?>[^()]+)|(?R))*\\)", "a(bc(d(e)f)gh", { backend: 'python' })).toStrictEqual(["(d(e);
  });

  it('regex.findall test 5', async () => {
    // Python: self.assertEqual(regex.findall(r"(?r)\((?:(?>[^()]+)|(?R))*\)", "a(bc(d(e)f)gh"), ["(d(e)f)"])
    expect(await re.findall("(?r)\\((?:(?>[^()]+)|(?R))*\\)", "a(bc(d(e)f)gh", { backend: 'python' })).toStrictEqual(["(d(e);
  });
  ...
  it('regex.search test 6', async () => {
    ...
    expect(await re.search("a(bc)d", "abcd", { backend: 'python' })?.group(0)).toStrictEqual("abcd");
  });

  it('regex.search test 7', async () => {
    // Python: # returns Noneself.assertEqual(regex.search(r"([\da-f:]+)$", "E", regex.I | regex.V1).group(0), "E")
    expect(await re.search("([\\da-f:]+)$", "E", { backend: 'python' })?.group(0)).toStrictEqual("E");
  });
  ...
  it('regex.search test 9', async () => {
    ...
    expect(await re.search("^(?=ab(de))(abd)(e)", "abde", { backend: 'python' })?.groups()).toStrictEqual(("de", "abd", "e");
  });
  ...
  it('regex.search test 10', async () => {
    ...
    expect(await re.search("^(a|)\\1{2}b", "b", { backend: 'python' })?.group(0, 1)).toStrictEqual(("b", "");
  });

  it('regex.search test 11', async () => {
    // Python: self.assertEqual(regex.search("^(a){0,0}", "abc").group(0, 1), ("", None))
    expect(await re.search("^(a){0, 0}", { backend: 'python' })?.group(0, 1)).toStrictEqual(("", None);
  });
  ...
  it('regex.search test 12', async () => {
    ...
    expect(await re.search("(?>.*/)b", "a/b", { backend: 'python' })?.group(0)).toStrictEqual("a/b");
  });
  ...
  it('regex.search test 18', async () => {
    ...
    expect(await re.search("a(?#xxx)*", "aaa", { backend: 'python' })?.group()).toStrictEqual("aaa");
  });
  ...
  it('regex.search test 19', async () => {
    ...
    expect(await re.search("(?=abc){3}abc", "abcabcabc", { backend: 'python' })?.span()).toStrictEqual((0, 3);
  });
  ...
  it('regex.search test 20', async () => {
    ...
    expect(await re.search("^(?:a(?:(?:))+)+", "a", { backend: 'python' })?.span()).toStrictEqual((0, 1);
  });

  it('regex.search test 21', async () => {
    // Python: self.assertEqual(regex.search("^(?:a(?:(?:))+)+", "aa").span(), (0, 2))
    expect(await re.search("^(?:a(?:(?:))+)+", "aa", { backend: 'python' })?.span()).toStrictEqual((0, 2);
  });
  ...
  it('regex.search test 22', async () => {
    ...
    expect(await re.search("a(?x: b c )d", "abcd", { backend: 'python' })?.group(0)).toStrictEqual("abcd");
  });
  ...
  it('regex.search test 28', async () => {
    ...
    expect(await re.search("(?V1)(a)(?<=b(?1))", "baz", { backend: 'python' })?.group(0)).toStrictEqual("a");
  });
  ...
  it('regex.findall test 29', async () => {
    ...
    expect(await re.findall("(?fi)\\L<keywords>", "POST, { backend: 'python' })).toStrictEqual(["POST", "Post", "post", "po\u017ft", "po\ufb06", "po\ufb05"],);
  });
  ...
  it('regex.findall test 30', async () => {
    ...
    expect(await re.findall("(?fi)pos|post", "POST, { backend: 'python' })).toStrictEqual(["POS", "Pos", "pos", "po\u017f", "po\ufb06", "po\ufb05"],);
  });
  ...
  it('regex.findall test 31', async () => {
    ...
    expect(await re.findall("(?fi)post|pos", "POST, { backend: 'python' })).toStrictEqual(["POST", "Post", "post", "po\u017ft", "po\ufb06", "po\ufb05"],);
  });
  ...
  it('regex.findall test 32', async () => {
    ...
    expect(await re.findall("(?fi)post|another", "POST, { backend: 'python' })).toStrictEqual(["POST", "Post", "post", "po\u017ft", "po\ufb06", "po\ufb05"],);
  });
  ...
  it('regex.search test 33', async () => {
    ...
    expect(await re.search("(?V1)((a)(?1)|(?2))", "a", { backend: 'python' })?.group(0, 1, 2)).toStrictEqual(("a", "a", None);
  });
  ...
  it('regex.search test 34', async () => {
    ...
    expect(await re.search("(?V1)(\\1xx|){6}", "xx", { backend: 'python' })?.span(0, 1)).toStrictEqual(((0, 2);
  });
  ...
  it('regex.search test 35', async () => {
    ...
    expect(await re.search("(a|)+", "a", { backend: 'python' })?.group(0, 1)).toStrictEqual(("a", "");
  });
  ...
  it('regex.search test 36', async () => {
    ...
    expect(await re.search("(a|)*\\d", "a" * 80, { backend: 'python' })).toStrictEqual(None);
  });
  ...
  it('regex.search test 37', async () => {
    ...
    expect(await re.search("^(?:a?b?)*$", "ac", { backend: 'python' })).toStrictEqual(None);
  });
  ...
  it('regex.search test 38', async () => {
    ...
    expect(await re.search("\\\\Z", "a\\na\\n", { backend: 'python' })?.span(0)).toStrictEqual((4, 4);
  });
  ...
  it('regex.search test 39', async () => {
    ...
    expect(await re.search("(q1|.)*(q2|.)*(x(a|bc)*y){2, }", { backend: 'python' })?.group(0)).toStrictEqual("xayxay");
  });
  ...
  it('regex.search test 40', async () => {
    ...
    expect(await re.search("(?i)[^a]", "A", { backend: 'python' })).toStrictEqual(None);
  });
  ...
  it('regex.search test 41', async () => {
    ...
    expect(await re.search("(?i)[[:ascii:]]", "\\N{KELVIN SIGN}", { backend: 'python' })).toStrictEqual(None);
  });

  it('regex.search test 42', async () => {
    // Python: self.assertEqual(regex.search("((a|b(?1)c){3,5})", "baaaaca").group(0, 1, 2),("aaaa", "aaaa", "a"),)
    expect(await re.search("((a|b(?1)c){3, 5})", { backend: 'python' })?.group(0, 1, 2)).toStrictEqual(("aaaa", "aaaa", "a");
  });
  ...
  it('regex.findall test 43', async () => {
    ...
    expect(await re.findall("(?<=:\\S+ )\\w+", ":9 abc :10 def", { backend: 'python' })).toStrictEqual(["abc", "def"]);
  });
  ...
  it('regex.search test 47', async () => {
    ...
    expect(await re.search("(?:fe)?male", "female", { backend: 'python' })?.group()).toStrictEqual("female");
  });
  ...
  it('regex.search test 48', async () => {
    ...
    expect(await re.search("(?<rec>\\((?:[^()]++|(?&rec))*\\))", "aaa(((1+0)+1)+1)bbb", { backend: 'python' })?.captures("rec")).toStrictEqual(["(1+0);
  });
  ...
  it('regex.match test 51', async () => {
    ...
    expect(await re.match("(?<x>a(?<x>b))", "ab", { backend: 'python' })?.spans("x")).toStrictEqual([(1, 2);
  });
// Skipped test 52: incomplete arguments in Python: # Hg issue 91: match.expand is extremely slow# Check that the replacement cache works.self.assertEqual(regex.sub(r"(-)", lambda m: m.expand(r"x"), "a-b-c"), "axbxc")
  ...
  it('regex.search test 53', async () => {
    ...
    expect(await re.search("^([^z]*(?:WWWi|W))?$", "WWWi", { backend: 'python' })?.groups()).toStrictEqual(("WWWi",);
  });
  ...
  it('regex.findall test 63', async () => {
    ...
    expect(await re.findall("\\bof ([a-z]+) of \\1\\b", "To make use of one of these modules", { backend: 'python' })).toStrictEqual([],);
  });
  ...
  it('regex.sub test 64', async () => {
    ...
    expect(await re.sub("x", "\\g<0>", "x", { backend: 'python' })).toBe("x");
  });
  ...
  it('regex.findall test 65', async () => {
    ...
    expect(await re.findall("(?V1)[[b-e]--cd]", "abcdef", { backend: 'python' })).toStrictEqual(["b", "e"]);
  });
  ...
  it('regex.findall test 67', async () => {
    ...
    expect(await re.findall("(?V1)[[bcde]--cd]", "abcdef", { backend: 'python' })).toStrictEqual(["b", "e"]);
  });
  ...
  it('regex.match test 69', async () => {
    ...
    expect(await re.match("(?:()|(?(1)()|z)){2}(?(2)a|z)", "a", { backend: 'python' })?.group(0, 1, 2)).toStrictEqual(("a", "", "");
  });

  it('regex.match test 70', async () => {
    // Python: self.assertEqual(regex.match("(?:()|(?(1)()|z)){0,2}(?(2)a|z)", "a").group(0, 1, 2),("a", "", ""),)
    expect(await re.match("(?:()|(?(1)()|z)){0, 2}(?(2)a|z)", { backend: 'python' })?.group(0, 1, 2)).toStrictEqual(("a", "", "");
  });
  ...
  it('regex.search test 71', async () => {
    ...
    expect(await re.search("([^L]*)([^R]*R)", "LtR", { backend: 'python' })?.groups()).toStrictEqual(("", "LtR");
  });
  ...
  it('regex.sub test 72', async () => {
    ...
    expect(await re.sub("(.)", "x\\1y", "ab", { backend: 'python' })).toBe("xayxby");
  });

  it('regex.sub test 73', async () => {
    // Python: self.assertEqual(regex.sub(r"(?r)(.)", r"x\1y", "ab"), "xayxby")
    expect(await re.sub("(?r)(.)", "x\\1y", "ab", { backend: 'python' })).toBe("xayxby");
  });
  ...
  it('regex.search test 74', async () => {
    ...
    expect(await re.search("OXRG", "OOGOX", { backend: 'python' })?.span()).toStrictEqual((3, 5);
  });

  it('regex.search test 75', async () => {
    // Python: self.assertEqual(regex.search(".XRG", "OOGOX", partial=True).span(), (3, 5))
    expect(await re.search(".XRG", "OOGOX", { backend: 'python' })?.span()).toStrictEqual((3, 5);
  });

  it('regex.search test 76', async () => {
    // Python: self.assertEqual(regex.search(".{1,3}XRG", "OOGOX", partial=True).span(), (1, 5)
    expect(await re.search(".{1, 3}XRG", { backend: 'python' })?.span()).toStrictEqual((1, 5);
  });
  ...
  it('regex.match test 77', async () => {
    ...
    expect(await re.match("R|R", "R", { backend: 'python' })?.span()).toStrictEqual((0, 1);
  });
  ...
  it('regex.match test 78', async () => {
    ...
    expect(await re.match("(.)(?(1)(?!))", "xy", { backend: 'python' })).toStrictEqual(None);
  });
  ...
  it('regex.findall test 79', async () => {
    ...
    expect(await re.findall("(y)?(\\d)(?(1)\\b\\B)", "ax1y2z3b", { backend: 'python' })).toStrictEqual([("", "1");
  });
  ...
  it('regex.match test 91', async () => {
    ...
    expect(await re.match("1(?>2)", "12", { backend: 'python' })?.span()).toStrictEqual((0, 2);
  });
  ...
  it('regex.search test 92', async () => {
    ...
    expect(await re.search("(abcdefgh){e}", "******abcdefghijklmnopqrtuvwxyz", { backend: 'python' })?.span()).toStrictEqual((6, 14);
  });
  ...
  it('regex.search test 93', async () => {
    ...
    expect(await re.search("(abcdefghi){e}", "******abcdefghijklmnopqrtuvwxyz", { backend: 'python' })?.span()).toStrictEqual((6, 15);
  });
  ...
  it('regex.match test 94', async () => {
    ...
    expect(await re.match("(?:(?=\\d)\\d+\\b|\\w+)", "123abc", { backend: 'python' })?.span()).toStrictEqual((0, 6);
  });

  it('regex.match test 95', async () => {
    // Python: self.assertEqual(regex.match(r"(?(?=\d)\d+\b|\w+)", "123abc"), None)
    expect(await re.match("(?(?=\\d)\\d+\\b|\\w+)", "123abc", { backend: 'python' })).toStrictEqual(None);
  });

  it('regex.search test 96', async () => {
    // Python: self.assertEqual(regex.search(r"(?(?<=love\s)you|(?<=hate\s)her)", "I love you").span(),(7, 10),)
    expect(await re.search("(?(?<=love\\s)you|(?<=hate\\s)her)", "I love you", { backend: 'python' })?.span()).toStrictEqual((7, 10);
  });
  ...
  it('regex.findall test 97', async () => {
    ...
    expect(await re.findall("(?(?<=love\\s)you|(?<=hate\\s)her)", "I love you but I don't hate her either", { backend: 'python' })).toStrictEqual(["you", "her"],);
  });
  ...
  it('regex.search test 98', async () => {
    ...
    expect(await re.search("(?p)a*(.*?)", "aaabbb", { backend: 'python' })?.group(0, 1)).toStrictEqual(("aaabbb", "bbb");
  });
  ...
  it('regex.sub test 100', async () => {
    ...
    expect(await re.sub("(?p)a*(.*?)", "\\1", "aaabbb", { backend: 'python' })).toBe("bbb");
  });
  ...
  it('regex.match test 102', async () => {
    ...
    expect(await re.match("(?irV0)\\L<kw>", "21", { backend: 'python' })?.span()).toStrictEqual((1, 2);
  });

  it('regex.match test 103', async () => {
    // Python: self.assertEqual(regex.match(r"(?irV1)\L<kw>", "21", kw=["1"]).span(), (1, 2))
    expect(await re.match("(?irV1)\\L<kw>", "21", { backend: 'python' })?.span()).toStrictEqual((1, 2);
  });
  ...
  it('regex.search test 104', async () => {
    ...
    expect(await re.search("a|b", "111a222", { backend: 'python' })?.span()).toStrictEqual((3, 4);
  });

  it('regex.search test 105', async () => {
    // Python: self.assertEqual(regex.search("(?r)a|b", "111a222").span(), (3, 4))
    expect(await re.search("(?r)a|b", "111a222", { backend: 'python' })?.span()).toStrictEqual((3, 4);
  });
  ...
  it('regex.search test 106', async () => {
    ...
    expect(await re.search("(?if)<(CLI)><\\1>", "<cli><cli>", { backend: 'python' })?.span()).toStrictEqual((0, 10);
  });
  ...
  it('regex.search test 108', async () => {
    ...
    expect(await re.search("(?ifr)<\\1><(CLI)>", "<cli><clI>", { backend: 'python' })?.span()).toStrictEqual((0, 10);
  });
  ...
  it('regex.findall test 115', async () => {
    ...
    expect(await re.findall("((brown)|(lazy)){1<=e<=3} ((dog)|(fox)){1<=e<=3}", "The quick borwn fax jumped over the lzy hog", { backend: 'python' })).toStrictEqual([("borwn", "borwn", "", "fax", "", "fax");
  });
  ...
  it('regex.search test 116', async () => {
    ...
    expect(await re.search("\\d\\d\\d-\\d\\d-\\d\\d\\d\\d", "My SSN is 999-89-76, { backend: 'python' })?.span()).toStrictEqual((36, 36);
  });
  ...
  it('regex.search test 117', async () => {
    ...
    expect(await re.search("(?r)\\1dog..(?<=(\\L<aa>))$", "ccdogcc", { backend: 'python' })?.span()).toStrictEqual((0, 7);
  });

  it('regex.search test 118', async () => {
    // Python: self.assertEqual(regex.search(r"(?ir)\1dog..(?<=(\L<aa>))$", "ccdogcc", aa=["bcb", "cc"]).span(),(0, 7),)
    expect(await re.search("(?ir)\\1dog..(?<=(\\L<aa>))$", "ccdogcc", { backend: 'python' })?.span()).toStrictEqual((0, 7);
  });
  ...
  it('regex.search test 119', async () => {
    ...
    expect(await re.search("(2)(?:\\1{5}){e<=1}", "3222212", { backend: 'python' })?.span()).toStrictEqual((1, 7);
  });

  it('regex.search test 120', async () => {
    // Python: self.assertEqual(regex.search(r"(\d)(?:\1{5}){e<=1}", "3222212").span(), (1, 7))
    expect(await re.search("(\\d)(?:\\1{5}){e<=1}", "3222212", { backend: 'python' })?.span()).toStrictEqual((1, 7);
  });
  ...
  it('regex.match test 121', async () => {
    ...
    expect(await re.match("""\\A(?P<whole>(?>\\((?&whole)\\)|[+\\-]))\\Z""", "((-))", { backend: 'python' })?.span()).toStrictEqual((0, 5);
  });

  it('regex.match test 122', async () => {
    // Python: self.assertEqual(regex.match(r"""\A(?P<whole>(?>\((?&whole)\)|[+\-]))\Z""", "((-)+)"), None)
    expect(await re.match("""\\A(?P<whole>(?>\\((?&whole)\\)|[+\\-]))\\Z""", "((-)+)", { backend: 'python' })).toStrictEqual(None);
  });
  ...
  it('regex.match test 123', async () => {
    ...
    expect(await re.match("x.*? (.).*\\1(.*)\\1", "x  |y| z|", { backend: 'python' })?.span()).toStrictEqual((0, 9);
  });

  it('regex.match test 124', async () => {
    // Python: self.assertEqual(regex.match(r"\.sr (.*?) (.)(.*)\2(.*)\2(.*)",r'.sr  h |<nw>|<span class="locked">|',).span(),(0, 35),)
    expect(await re.match("\\.sr (.*?) (.)(.*)\\2(.*)\\2(.*)", ".sr  h |<nw>|<span class="locked">|", { backend: 'python' })?.span()).toStrictEqual((0, 35);
  });
  ...
  it('regex.match test 125', async () => {
    ...
    expect(await re.match("\\w*(ea)\\w*|\\w*e(?!a)\\w*", "easier", { backend: 'python' })?.groups()).toStrictEqual(("ea",);
  });
  ...
  it('regex.search test 126', async () => {
    ...
    expect(await re.search("(^1234$){i, d}", { backend: 'python' })?.span()).toStrictEqual((0, 5);
  });

  it('regex.search test 127', async () => {
    // Python: self.assertEqual(regex.search("(^1234$){s,i,d}", "12234", regex.BESTMATCH).span(), (0, 5)
    expect(await re.search("(^1234$){s, i, { backend: 'python' })?.span()).toStrictEqual((0, 5);
  });
  ...
  it('regex.search test 128', async () => {
    ...
    expect(await re.search("(^123$){s, i, { backend: 'python' })?.span()).toStrictEqual((0, 11);
  });
  ...
  it('regex.search test 129', async () => {
    ...
    expect(await re.search("a?yz", "xxxxyz", { backend: 'python' })?.span()).toStrictEqual((4, 6);
  });

  it('regex.findall test 130', async () => {
    // Python: self.assertEqual(regex.findall(r"(?:(?![a-d]).)+", "abcdefgh"), ["efgh"])
    expect(await re.findall("(?:(?![a-d]).)+", "abcdefgh", { backend: 'python' })).toStrictEqual(["efgh"]);
  });

  it('regex.findall test 131', async () => {
    // Python: self.assertEqual(regex.findall(r"""(?(DEFINE)(?P<mydef>(?:(?![a-d]).)))(?&mydef)+""", "abcdefgh"),["efgh"],)
    expect(await re.findall("""(?(DEFINE)(?P<mydef>(?:(?![a-d]).)))(?&mydef)+""", "abcdefgh", { backend: 'python' })).toStrictEqual(["efgh"],);
  });
  ...
  it('regex.search test 136', async () => {
    ...
    expect(await re.search("(?:ESTONIA(?!\\w)){e<=1}", "ESTONIAN WORKERS", { backend: 'python' })?.group()).toStrictEqual("ESTONIAN",);
  });
  ...
  it('regex.search test 138', async () => {
    ...
    expect(await re.search("(?:(?<!\\w)ESTONIA){e<=1}", "BLUB NESTONIA", { backend: 'python' })?.group()).toStrictEqual("NESTONIA",);
  });
  ...
  it('regex.search test 140', async () => {
    ...
    expect(await re.search("(?r)(?:ESTONIA(?!\\w)){e<=1}", "ESTONIAN WORKERS", { backend: 'python' })?.group()).toStrictEqual("ESTONIAN",);
  });
  ...
  it('regex.search test 142', async () => {
    ...
    expect(await re.search("(?r)(?:(?<!\\w)ESTONIA){e<=1}", "BLUB NESTONIA", { backend: 'python' })?.group()).toStrictEqual("NESTONIA",);
  });
  ...
  it('regex.search test 144', async () => {
    ...
    expect(await re.search("(?:A.*B.*CDE){e<=2}", "A B CYZ", { backend: 'python' })?.group()).toStrictEqual("A B CYZ");
  });
  ...
  it('regex.search test 148', async () => {
    ...
    expect(await re.search("(?(?=A)A|B)", "A", { backend: 'python' })?.span()).toStrictEqual((0, 1);
  });

  it('regex.search test 149', async () => {
    // Python: self.assertEqual(regex.search(r"(?(?=A)A|B)", "B").span(), (0, 1))
    expect(await re.search("(?(?=A)A|B)", "B", { backend: 'python' })?.span()).toStrictEqual((0, 1);
  });

  it('regex.search test 150', async () => {
    // Python: self.assertEqual(regex.search(r"(?(?=A)A|)", "B").span(), (0, 0))
    expect(await re.search("(?(?=A)A|)", "B", { backend: 'python' })?.span()).toStrictEqual((0, 0);
  });

  it('regex.search test 151', async () => {
    // Python: self.assertEqual(regex.search(r"(?(?=X)X|)", "").span(), (0, 0))
    expect(await re.search("(?(?=X)X|)", "", { backend: 'python' })?.span()).toStrictEqual((0, 0);
  });

  it('regex.search test 152', async () => {
    // Python: self.assertEqual(regex.search(r"(?(?=X))", "").span(), (0, 0))
    expect(await re.search("(?(?=X))", "", { backend: 'python' })?.span()).toStrictEqual((0, 0);
  });
  ...
  it('regex.search test 153', async () => {
    ...
    expect(await re.search("(?(DEFINE)(?<func>.))(?&func)", "abc", { backend: 'python' })?.groups()).toStrictEqual((None,);
  });

  it('regex.search test 154', async () => {
    // Python: self.assertEqual(regex.search(r"(?(DEFINE)(?<func>.))(?&func)", "abc").groupdict(),{"func": None},)
    expect(await re.search("(?(DEFINE)(?<func>.))(?&func)", "abc", { backend: 'python' })?.groupdict()).toStrictEqual({"func": None},);
  });

  it('regex.search test 155', async () => {
    // Python: self.assertEqual(regex.search(r"(?(DEFINE)(?<func>.))(?&func)", "abc").capturesdict(),{"func": ["a"]},)
    expect(await re.search("(?(DEFINE)(?<func>.))(?&func)", "abc", { backend: 'python' })?.capturesdict()).toStrictEqual({"func": ["a"]},);
  });
  ...
  it('regex.search test 162', async () => {
    ...
    expect(await re.search("[a-z]+ [a-z]*?:", "foo bar", { backend: 'python' })?.span()).toStrictEqual((0, 7);
  });

  it('regex.search test 163', async () => {
    // Python: self.assertEqual(regex.search(r"(?r):[a-z]*? [a-z]+", "foo bar", partial=True).span(), (0, 7)
    expect(await re.search("(?r):[a-z]*? [a-z]+", "foo bar", { backend: 'python' })?.span()).toStrictEqual((0, 7);
  });
  ...
  it('regex.findall test 164', async () => {
    ...
    expect(await re.findall("\\X", "\\U0001f468\\u200d\\U0001f469\\u200d\\U0001f467\\u200d\\U0001f466", { backend: 'python' })).toStrictEqual(["\U0001f468\u200d\U0001f469\u200d\U0001f467\u200d\U0001f466"],);
  });
  ...
  it('regex.search test 165', async () => {
    ...
    expect(await re.search("""(?(DEFINE)(?<mydef>(?<wrong>THIS_SHOULD_NOT_MATCHx?)|(?<right>right))).*(?<=(?&mydef).*)""", "x right", { backend: 'python' })?.capturesdict()).toStrictEqual({"mydef": ["right"], "wrong": [], "right": ["right"]},);
  });
  ...
  it('regex.search test 166', async () => {
    ...
    expect(await re.search("\\b(?e)(?:\\d{6, 20}){i<=5:[\\-\\\\\\/]}\\b", { backend: 'python' })).toStrictEqual(None,);
  });
  ...
  it('regex.findall test 167', async () => {
    ...
    expect(await re.findall("(\\d+){i<=2:[ab]}", "123X4Y5", { backend: 'python' })).toStrictEqual(["123", "4", "5"]);
  });

  it('regex.findall test 168', async () => {
    // Python: self.assertEqual(regex.findall(r"(?i)(\d+){i<=2:[ab]}", "123X4Y5"), ["123", "4", "5"])
    expect(await re.findall("(?i)(\\d+){i<=2:[ab]}", "123X4Y5", { backend: 'python' })).toStrictEqual(["123", "4", "5"]);
  });
  ...
  it('regex.match test 169', async () => {
    ...
    expect(await re.match("t(?:es){s<=1:\\d}t", "te5t", { backend: 'python' })?.group()).toStrictEqual("te5t");
  });

  it('regex.match test 170', async () => {
    // Python: self.assertEqual(regex.match(r"t(?:es){s<=1:\d}t", "tezt"), None)
    expect(await re.match("t(?:es){s<=1:\\d}t", "tezt", { backend: 'python' })).toStrictEqual(None);
  });

  it('regex.match test 171', async () => {
    // Python: self.assertEqual(regex.match(r"t(?:es){i<=1:\d}t", "tes5t").group(), "tes5t")
    expect(await re.match("t(?:es){i<=1:\\d}t", "tes5t", { backend: 'python' })?.group()).toStrictEqual("tes5t");
  });

  it('regex.match test 172', async () => {
    // Python: self.assertEqual(regex.match(r"t(?:es){i<=1:\d}t", "teszt"), None)
    expect(await re.match("t(?:es){i<=1:\\d}t", "teszt", { backend: 'python' })).toStrictEqual(None);
  });

  it('regex.match test 173', async () => {
    // Python: self.assertEqual(regex.match(r"t(es){i<=1,0<e<=1}t", "tes5t").group(), "tes5t")
    expect(await re.match("t(es){i<=1, 0<e<=1}t", { backend: 'python' })?.group()).toStrictEqual("tes5t");
  });
...
// Skipped test 177: incomplete arguments in Python: self.assertEqual(regex.compile("a|\\.*pb\\.py").search(".geojs"), None)
  ...
  it('regex.sub test 178', async () => {
    ...
    expect(await re.sub("(test1)|(test2)", "matched: \\1\\2", "test1", { backend: 'python' })).toBe("matched: test1");
  });
  ...
  it('regex.search test 179', async () => {
    ...
    expect(await re.search("(test1)|(test2)", "matched: test1", { backend: 'python' })?.expand(r"matched: \1\2")).toStrictEqual("matched: test1",);
  });
  ...
  it('regex.search test 180', async () => {
    ...
    expect(await re.search("(?:\\bha\\b){i:[ ]}", "having", { backend: 'python' })).toStrictEqual(None);
  });
  ...
  it('regex.match test 182', async () => {
    ...
    expect(await re.match("(?a:\\w)\\w", "d\\N{CYRILLIC SMALL LETTER ZHE}", { backend: 'python' })?.span()).toStrictEqual((0, 2);
  });

  it('regex.match test 183', async () => {
    // Python: self.assertEqual(regex.match(r"(?a:\w)(?u:\w)", "d\N{CYRILLIC SMALL LETTER ZHE}").span(),(0, 2),)
    expect(await re.match("(?a:\\w)(?u:\\w)", "d\\N{CYRILLIC SMALL LETTER ZHE}", { backend: 'python' })?.span()).toStrictEqual((0, 2);
  });
  ...
  it('regex.match test 184', async () => {
    ...
    expect(await re.match("^\\p{LC}+$", "\\N{SMILING CAT FACE WITH OPEN MOUTH}", { backend: 'python' })).toStrictEqual(None);
  });

  it('regex.match test 185', async () => {
    // Python: self.assertEqual(regex.match(r"^\p{So}+$", "\N{SMILING CAT FACE WITH OPEN MOUTH}").span(),(0, 1),)
    expect(await re.match("^\\p{So}+$", "\\N{SMILING CAT FACE WITH OPEN MOUTH}", { backend: 'python' })?.span()).toStrictEqual((0, 1);
  });
  ...
  it('regex.match test 186', async () => {
    ...
    expect(await re.match("(.)+", "abc", { backend: 'python' })?.allcaptures()).toStrictEqual((["abc"], ["a", "b", "c"]);
  });

  it('regex.match test 187', async () => {
    // Python: self.assertEqual(regex.match(r"(.)+", "abc").allspans(), ([(0, 3)], [(0, 1), (1, 2), (2, 3)])
    expect(await re.match("(.)+", "abc", { backend: 'python' })?.allspans()).toStrictEqual(([(0, 3);
  });
  ...
  it('regex.match test 188', async () => {
    ...
    expect(await re.match("(?(?<=A)|(?(?![^B])C|D))", "A", { backend: 'python' })).toStrictEqual(None);
  });

  it('regex.search test 189', async () => {
    // Python: self.assertEqual(regex.search(r"(?(?<=A)|(?(?![^B])C|D))", "A").span(), (1, 1))
    expect(await re.search("(?(?<=A)|(?(?![^B])C|D))", "A", { backend: 'python' })?.span()).toStrictEqual((1, 1);
  });
  ...
  it('regex.search test 190', async () => {
    ...
    expect(await re.search("^a?(a?)b?c\\1$", "abca", { backend: 'python' })?.span()).toStrictEqual((0, 4);
  });
  ...
  it('regex.match test 191', async () => {
    ...
    expect(await re.match("(?(?=a).|..)", "ab", { backend: 'python' })?.span()).toStrictEqual((0, 1);
  });

  it('regex.match test 192', async () => {
    // Python: self.assertEqual(regex.match(r"(?(?=b).|..)", "ab").span(), (0, 2))
    expect(await re.match("(?(?=b).|..)", "ab", { backend: 'python' })?.span()).toStrictEqual((0, 2);
  });

  it('regex.match test 193', async () => {
    // Python: self.assertEqual(regex.match(r"(?(?!a).|..)", "ab").span(), (0, 2))
    expect(await re.match("(?(?!a).|..)", "ab", { backend: 'python' })?.span()).toStrictEqual((0, 2);
  });

  it('regex.match test 194', async () => {
    // Python: self.assertEqual(regex.match(r"(?(?!b).|..)", "ab").span(), (0, 1))
    expect(await re.match("(?(?!b).|..)", "ab", { backend: 'python' })?.span()).toStrictEqual((0, 1);
  });
  ...
  it('regex.match test 195', async () => {
    ...
    expect(await re.match("(\\L<foo>){e<=5}", "blah", { backend: 'python' })?.span()).toStrictEqual((0, 0);
  });
// Skipped test 196: incomplete arguments in Python: # Git issue 527: `VERBOSE`/`X` flag breaks `\N` escapesself.assertEqual(regex.compile(r"\N{LATIN SMALL LETTER A}").match("a").span(), (0, 1)
  ...
  it('regex.compile test 197', async () => {
    ...
    expect(await re.compile("\\N{LATIN SMALL LETTER A}", flags=regex.X, { backend: 'python' })?.match("a").span()).toStrictEqual((0, 1);
  });
