...
describe('Python Backend - Regex (converted)', () => {
  ...
  it('regex.findall test 5', async () => {
    ...
    expect(await re.findall("(?w).+", "Line 1\\rLine 2\\r", { backend: 'python' })).toStrictEqual(["Line 1", "Line 2"]);
  });
  ...
  it('regex.search test 12', async () => {
    ...
    expect(await re.search("(?w)^abc", "\\rabc", { backend: 'python' })).toStrictEqual(None);
  });
  ...
  it('regex.search test 24', async () => {
    ...
    expect(await re.search("(?mw)^abc", "\\rabc", { backend: 'python' })?.start()).toStrictEqual(1);
  });
  ...
  it('regex.search test 27', async () => {
    ...
    expect(await re.search("(?m)abc$", "abc\\r", { backend: 'python' })).toStrictEqual(None);
  });
